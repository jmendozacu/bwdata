...
echo "After bakeway_17_8_2018 this program, enter your database password for root"
DATABASENAME=bakeway_17_8_2018

mysql -u root -p'root' <<-ENDMARKER
...
update `sales_order_address`  set email = "1234567@gmail.com",telephone = "1234567891" ORDER BY `entity_id` DESC;
