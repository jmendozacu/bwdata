...
namespace Bakeway\ReviewRating\Controller\Adminhtml\Rewrite\Rating;
    ...
    public function execute()
    {
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                $ratingType = (int)$this->getRequest()->getParam('rating_type');

                $questionType = $this->getRequest()->getParam('q_type');
