    ...
    public function initForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                src="' . $this->_marketplaceHelper->getMediaUrl() . 'payment_doc/' . $partner['userdata_cancelled_cheque'] . '"
                />',
            ]
        );
        $fieldset->addField(
            ...
            [
                ...
                <a target="_blank" href="'.$this->_marketplaceHelper->getMediaUrl() . 'payment_doc/' . $partner['userdata_agreement_document'].'"
