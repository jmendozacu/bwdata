...
class SalesQuoteCollectionAfter
        implements ObserverInterface
{
    ...
    CartExtensionFactory $extensionFactory,
            ...
            DeliveryShippingHelper $deliveryShippingHelper,
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        foreach ($quote->getAllItems() as $quoteItem) {
            ...
            $itemImageUrl = $this->getImageUrl($productObj,
            ...
            string $imageType = '')
    {
        ...
        $imageUrl = $imageUrl = $this->productImageHelper->create()->init($product,
                        $imageType)->getUrl();
    ...
    public function getAttributeLabel($product,
            $code)
    {
