 ...
 */
namespace Bakeway\Partnerlocations\Block\Adminhtml\Customer\Edit\Tab;
...
class Locations extends \Magento\Backend\Block\Widget\Form\Generic implements TabInterface
{
     ...
     * @var string
     */
    protected $_template = 'tab/locationsgrid.phtml';
    ...
    protected function _prepareLayout()
    {
        $this->setChild(
            ...
            $this->getLayout()->createBlock(
                'Bakeway\Partnerlocations\Block\Adminhtml\Customer\Edit\Tab\View\Grid',
                'partnerlocationsseller.grid'
            )
        );
