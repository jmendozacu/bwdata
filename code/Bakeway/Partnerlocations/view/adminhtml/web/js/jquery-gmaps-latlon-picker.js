...
// ^^^
    ...
    $(document).ready(function () {
        ...
        $('.setLatLon').on('click', function () {
            $('#page_store_latitude').val($('.gllpLatitude').val());
            $('#page_store_longitude').val($('.gllpLongitude').val());
            $('.close').click();
        });

        if ($("body").hasClass("partnerlocations-locations-edit")) {
        ...
        var counter = 0;
        if ($("body").hasClass("customer-index-edit")) {
            setInterval(function () {
                if ($('#tab_block_customer_edit_tab_locations').length && counter === 0) {
                    jQuery('#tab_block_customer_edit_tab_locations').click(function () {
                        setTimeout(function () {
                            if (!jQuery.gMapsLatLonPickerNoAutoInit) {
                                ...
                                $('.setLatLon').on('click', function () {
                                    $('#tab_store_latitude').val($('.gllpLatitude').val());
                                    $('#page_store_longitude').val($('.gllpLongitude').val());
                                    $('.close').click();
                                });
