...
use Webkul\Marketplace\Model\Seller as Sellerinstance;
...
class MassApprove extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($collection as $item) {
            ...
            $visibilityIds = $productModel->getVisibility();
            if ($visibilityIds != 4) {
                continue;
            }
            ...
            $sellerModel = $this->sellerinstance->getCollection()
	        ...
	        $emailTemplateVariables['myvar8']  = $imageUrl;
            $emailTemplateVariables['sku']  = $productModel->getSku();
            ...
            /**
                 * Commenting the code as per BKWYADMIN-157
                 */
            /*
            ...
            /* email id and name for getting alert of approve product */
                /* start */

            $emailTemplateVariables['sellerId'] = $item->getSellerId();
           echo  $sellerbusinessName = $sellerModel->getData('business_name');
           echo  $sellerCity = $this->citieshelper->getCityNameById($sellerModel->getData('store_city'));
            $emailTemplateVariables['sellerbusinessName'] = $sellerbusinessName;
            $emailTemplateVariables['cityName']=$sellerCity;



            $dissStoremail = $helper->getAppProEmailId();
            if(!empty($dissStoremail)):
            //$dissStoename = $helper->getAppProName();
            //$dissStoremail = 'kushagra@relfor.com,kushagra.daharwal@hotmail.com';
            $dissStoename =  'Support';
            ...
            $this->_objectManager->get('Webkul\Marketplace\Helper\Email')->sendApprovedProEmail($all_EmailAddress,$emailTemplateVariables, $senderInfoCustom);
            endif;
            /* end */
