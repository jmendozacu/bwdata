...
class Email extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const XML_PATH_EMAIL_DISAPPROVE_PRODUCT_CUSTOM = 'marketplace/email/product_disapprove_notification_template_custom';
    const XML_PATH_EMAIL_APPROVE_PRODUCT_CUSTOM = 'marketplace/email/product_approve_notification_template_custom';
    const XML_PATH_EMAIL_SELLER_DISAPPROVE_CUSTOM = 'marketplace/email/seller_disapprove_notification_template_custom';
    const XML_PATH_EMAIL_SELLER_APPROVE_CUSTOM = 'marketplace/email/seller_approve_notification_template_custom';
   ...
   /**
     * seding email to marketing team
     * [sendSellerApproveMail description].
     *
     * @param Mixed $emailTemplateVariables
     * @param Mixed $senderInfo
     * @param Mixed $receiverInfo
     */
    public function sendProductUnapproveMailCustom($emailTemplateVariables, $senderInfo, $receiverInfo)
    {
        $this->_template = $this->getTemplateId(self::XML_PATH_EMAIL_DISAPPROVE_PRODUCT_CUSTOM);
        $this->_inlineTranslation->suspend();
        $this->generateTemplate($emailTemplateVariables, $senderInfo, $receiverInfo);
        try {
           $transport = $this->_transportBuilder->getTransport();
     ...
     * @param Mixed $receiverInfo
     */
    public function sendDisApprovedProEmail($all_EmailAddress,$emailTemplateVariables, $senderInfoCustom)
    {
           ...
           try{
               ...
               foreach($all_EmailAddress as $emailAddress){
                   ...
                   $this->sendProductUnapproveMailCustom(
                       $emailTemplateVariables, $senderInfoCustom, $receiverInfo
                   );
        ...
        /**
     * product approval email to marketing team
     * send
     * [sendProductUnapproveMail description].
     *
     * @param Mixed $emailTemplateVariables
     ...
     * @param Mixed $receiverInfo
     */
    public function sendProductApproveMailCustom($emailTemplateVariables, $senderInfo, $receiverInfo)
    {
       $this->_template = $this->getTemplateId(self::XML_PATH_EMAIL_APPROVE_PRODUCT_CUSTOM);
     ...
     * @param Mixed $receiverInfo
     */
    public function sendApprovedProEmail($all_EmailAddress,$emailTemplateVariables, $senderInfoCustom)
    {
     ...
     try{
        ...
        foreach($all_EmailAddress as $emailAddress){
            ...
            $this->sendProductApproveMailCustom(
                $emailTemplateVariables, $senderInfoCustom, $receiverInfo
            );
...
/**
     ...
     * @param Mixed $receiverInfo
     */
    public function sendSellerDisapproveMailToMarketingTeam($emailTemplateVariables, $senderInfo, $receiverInfo)
    {
        $this->_template = $this->getTemplateId(self::XML_PATH_EMAIL_SELLER_DISAPPROVE_CUSTOM);
        $this->_inlineTranslation->suspend();
        $this->generateTemplate($emailTemplateVariables, $senderInfo, $receiverInfo);
        try {
           $transport = $this->_transportBuilder->getTransport();
     ...
     * @param Mixed $receiverInfo
     */
    public function sendDispprovedSellerEmail($all_EmailAddress,$emailTemplateVariables, $senderInfoCustom)
    {
        ...
        try{
            ...
            foreach($all_EmailAddress as $emailAddress){
                ...
                $this->sendSellerDisapproveMailToMarketingTeam(
                    $emailTemplateVariables, $senderInfoCustom, $receiverInfo
                );
     ...
     * @param Mixed $receiverInfo
     */
    public function sendApprovedSellerEmail($all_EmailAddress,$emailTemplateVariables, $senderInfoCustom)
    {
        ...
        try{
            ...
            foreach($all_EmailAddress as $emailAddress){
                ...
                $this->sendSellerAapproveMailToMarketingTeam(
                    $emailTemplateVariables, $senderInfoCustom, $receiverInfo
                );
    ...
    /**
     * [sendSellerAapproveMail description].
     *
     * @param Mixed $emailTemplateVariables
     * @param Mixed $senderInfo
     * @param Mixed $receiverInfo
     */
    public function sendSellerAapproveMailToMarketingTeam($emailTemplateVariables, $senderInfo, $receiverInfo)
    {
        $this->_template = $this->getTemplateId(self::XML_PATH_EMAIL_SELLER_APPROVE_CUSTOM);
        $this->_inlineTranslation->suspend();
        $this->generateTemplate($emailTemplateVariables, $senderInfo, $receiverInfo);
        try {
            $transport = $this->_transportBuilder->getTransport();
