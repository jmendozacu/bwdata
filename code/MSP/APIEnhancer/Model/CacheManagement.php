...
class CacheManagement implements CacheManagementInterface
{
    ...
    {
        $cacheKey = "API_ENHANCER".$this->getCacheKey();
    ...
    /**
     * Clean matching tags result
     * @param string $mode
     * @param array $tags
     * @return void
     */
    public function cleanCacheResult($mode, array $tags = [])
    {
        $mode = \Zend_Cache::CLEANING_MODE_MATCHING_ANY_TAG;
        $tags = ["catalog_product_1942"];
        $this->cacheType->clean($mode, $tags);
    }
}
